...
public class MenuPanel : MonoBehaviour
{
	...
	{
		playerName.text = $"안녕하시와요,{PhotonNetwork.LocalPlayer.NickName}";
		CancelButtonClick();	
	}
	...
	private void CreateButtonClick()
	{
		...
		PhotonNetwork.CreateRoom(roomName, option);//최대 플레이어가 8먕인 방 생성
	}
	...
	public void NicknameUpdateButtonClick()
	{
		...
		playerName.text = $"안녕하시와요,{PhotonNetwork.NickName}";
	}
